...
Hall::Hall()
    : _pin(255),
//------------OPS------------------
      _pulsesPerRevolution(1), //might be 3, beacuse there is 3 magnets on the wheel... it it work when the value is '1' and it not testet with the value '3'. so PLEASE test if it wwork... 
                               // i will give you a hug, if you test it :) (28-02-2026)
//------------OPS------------------
      _slopeWindowSize(5),
      _lastPulseUs(0),
      _intervalUs(0),
